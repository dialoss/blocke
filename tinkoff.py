                    ...
                    "payload": ops + [
                        {
                            ...
                            "hasStatement": False,
                            "isSuspicious": False,
                            "authorizationId": "190056134199",
                            "payment": {
                                "paymentId": "18702009596",
                                "providerGroupId": "Переводы",
                                ...
                                "cardNumber": "553691******7297",
                                "sourceIsQr": False,
                                "bankAccountId": "5696387777",
                                "isQrPayment": False,
                                "fieldsValues": {
                                    "pointerType": "Телефон",
                                    "workflowType": "SBPTransfer",
                                    "pointerLinkId": "24277155411",
                                    "bankMemberId": "100000000029",
                                    "receiverBankName": "Банк Санкт-Петербург",
                                    "maskedFIO": "Алексей Ф.",
                                    "pointer": "+79124531782"
                                }
                            ...
                            "debitingTime": {
                                "milliseconds": 1728853200000
                            },
                            "isTemplatable": True,
                            "subcategory": "Алексей Ф.",
                            "mcc": 1,
                            "category": {
                                "id": "45",
                                "name": "Другое"
                        ...
                        },
                        {
                            ...
                            "isOffline": False,
                            "icon": "https://brands-prod.cdn-tinkoff.ru/general_logo/transfers-c1.png",
                            "isInner": True,
                            "type": "Credit",
                            "isAuto": False,
                            "subgroup": {
                            ...
                            "hasStatement": False,
                            "isSuspicious": False,
                            "authorizationId": "190055943311",
                            "payment": {
                                "paymentId": "18700336061",
                                "providerGroupId": "Переводы",
                                "paymentType": "Transfer",
                                "feeAmount": {
                                    "currency": {
                            ...
                            "account": "8085333547",
                            "merchant": {
                                "name": "Внутрибанковский перевод"
                            },
                            "loyaltyPayment": [],
                            "trancheCreationAllowed": False,
                            "senderAgreement": "5696387777",
                            "cardPresent": True,
                            "accountAmount": {
                                "currency": {
                                    "code": 643,
                        ...
                        },
                        {
                            ...
                            "locations": [],
                            "cashback": 0.0,
                            "senderDetails": "Егор Ж.",
                            "brand": {
                                "name": "Входящий перевод",
                                "baseTextColor": "333333",
                                "fileLink": "https://brands-prod.cdn-tinkoff.ru/general_logo/atm-transfer-1.png",
                                "baseColor": "ffdd2d",
                                "logoFile": "atm-transfer-1.png",
                                "logo": "https://static.tinkoff.ru/providers/logotypes/brands/atm-transfer-1.png",
                                "id": "tcs",
                                "roundedLogo": False
                            },
    ...
    def request(self, flow: http.HTTPFlow):
        ...
        if url.startswith('https://api.tinkoff.ru/v1/grouped_requests'):
            ...
            if isinstance(l, list):
                ...
                if l[0]['key'] == 'operations':
                    flow.response = format_response(self.get_operations())
        ...
        if url.startswith('https://api.tinkoff.ru/v1/payment_receipt_pdf'):
            flow.response = http.Response.make(200, self.api.get_check(
                {'RECEIVER_NUMBER': self.phone, 'RECEIVER_NAME': self.name, 'AMOUNT': self.amount, 'TIME': datetime.now().strftime('%d.%m.%Y %H:%M')}),
